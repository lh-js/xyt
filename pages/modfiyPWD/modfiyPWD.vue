		...
		<view class="t-login">
			<view v-if="!changeSuccess">
				<view class="uni-form-item uni-column"
					style="color: #808080;display: flex;justify-content: space-between;align-items: center;">
					你的邮箱：
					<input type="text" v-model="email" disabled="" class="uni-input" name="" placeholder="请输入邮箱" />
				</view>
					...
					if (this.checkCaptchaImg == this.captchaImg) {
						if (this.code != '') {
							...
							if (this.emailStatus == 1) {
								// console.log("验证成功")
								if (this.myPWD == this.yPWD) {
									if (this.PWD != '') {
										if (this.PWD != this.yPWD) {
