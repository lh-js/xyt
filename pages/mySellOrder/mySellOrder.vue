<template>
	<view>
		<view
			style="width: 100%;height: 80rpx;display: flex;align-items: center;justify-content: center;position: fixed;top: 0;z-index: 999;background: #FFFFFF;">
			<uni-segmented-control style="width: 100%;" :current="current" :values="items" @clickItem="onClickItem"
		...
		<view v-if="!isData"
			...
			<uni-card>
				<view class="cart-item-user" style="display: flex;">
					<uni-icons type="person-filled" size="30" color="#0bc99d"></uni-icons>
